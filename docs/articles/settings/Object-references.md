...
title: "Settings - Object references"
---
...
NOTE: in Mapster setting is per type pair, not per hierarchy (see [**Configuration for nested Classes**](xref:Mapster.Configuration.NestedMapping)). Therefore, you need to apply config to all type pairs.
...
![inline-class-mapping-diagram](https://cloud.githubusercontent.com/assets/21364231/25666644/ce38c8c0-3029-11e7-8793-8a51c519c2a0.png)
